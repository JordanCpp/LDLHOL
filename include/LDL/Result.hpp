...
void LDL_Result::Message(const char* message, const char* detail)
{
	...
	LDL_ASSERT((LDL_CharsLength(message) + LDL_CharsLength(detail)) < Max);

	LDL_CharsCopy(_message, message, Max);
	LDL_CharsConcat(_message, detail, Max);
}
